...
@MainActor
func spawnCloud() async throws -> Entity {  // @@ called by happybeam
    let start = Point3D(
...
@MainActor
func spawnCloudExact(start: Point3D, end: Point3D, speed: Double) async throws -> Entity { // @@handling with how to dispaly clouds, called by spawnCloud()
